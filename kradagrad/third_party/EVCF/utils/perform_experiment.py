...
def experiment_vae(
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        writer.add_scalar("Loss/train_kl", train_kl_epoch, epoch)

        val_loss_epoch, val_re_epoch, val_kl_epoch, val_ndcg_epoch = evaluate(
        ...
        val_loss_history.append(val_loss_epoch), val_re_history.append(
            val_re_epoch
        ), val_kl_history.append(val_kl_epoch), val_ndcg_history.append(val_ndcg_epoch)
    ...
    return test_loss, test_re, test_kl, test_ndcg
